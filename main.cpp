  ...
  cin >> opcao;
   ...
   switch (opcao) {
      case 1: cout << "Digite o primeiro número: ";
        ...
        cin >> num2;
        resultado=num1+num2;
        cout << "O resultado é " << resultado << "."; break;
       
      case 2: cout << "Digite o primeiro número: ";
        cin >> num1;
        cout << "Digite o segundo número: ";
        cin >> num2;
        resultado=num1-num2; 
      ...
      case 3: cout << "Digite o primeiro número: ";
        cin >> num1;
        cout << "Digite o segundo número: ";
        cin >> num2;
        resultado=num1*num2;
      ...
      case 4: cout << "Digite o primeiro número: ";
        cin >> num1;
        cout << "Digite o segundo número: ";
        cin >> num2;
       resultado=num1/num2;
      ...
      default: cout << "Erro. Tente Novamente.";break;
    }
